...
void subMenuDirectivoProfesor()
{
    ...
    case 48:
        system("cls");
        cout << "VOLVIENDO AL MEN� DIRECTIVO..." << endl;
        Sleep(2000);
        system("cls");
        menuDirectivo();
        break;
...
void asignarProfesores()
{
    ...
    while (fread(&materiaObj, sizeof(Materia), 1, pMat))
    {
        ...
        while (!valido)
        {
            ...
            if (!valido)
            {
                cout << endl << "---- ERROR: NO SE ENCONTR� UN PROFESOR CON LEGAJO '" << legajoProfesor << "' CARGADO EN EL SISTEMA ----" << endl;
            }
        }
...
void subMenuAlumnoPlanificacionCursada()
{
    ...
    CARGANDO();
    cout << "-----------------------------------------------------"<< endl;
    cout << "               MEN� PLANIFICAR CURSADA               "<< endl;
    cout << "-----------------------------------------------------"<< endl;
    ...
    case 48:
        system("cls");
        cout << "VOLVIENDO AL MEN� ALUMNO..." << endl;
        Sleep(2000);
        system("cls");
        menuAlumno();
        break;
